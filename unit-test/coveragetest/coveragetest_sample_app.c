...
void Test_SAMPLE_ReportHousekeeping(void)
{
    ...
    sample_hk_tlm_t         HkTelemetryMsg;
     ...
     */
    UtAssert_True(HkTelemetryMsg.sample_command_count == 22,
            "HkTelemetryMsg.sample_command_count (%u) == 22",
            (unsigned int)HkTelemetryMsg.sample_command_count);

    UtAssert_True(HkTelemetryMsg.sample_command_error_count == 11,
            "HkTelemetryMsg.sample_command_error_count (%u) == 11",
            (unsigned int)HkTelemetryMsg.sample_command_error_count);
